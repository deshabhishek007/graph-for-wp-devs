...
This repository publishes immutable release knowledge, not a graph of its own build scripts. Do not run `graphify update .` for WordPress questions. Claude Code and Codex must consume the same selected pack.
